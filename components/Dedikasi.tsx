...
// Component for displaying the main images in the Dedikasi section
const DedikasiImage = () => {
  return (
...
// Component for displaying the main content in the Dedikasi section
const DedikasiContent = () => {
  return (
    <div className="mt-36 space-y-5 lg:mt-0 lg:w-1/2 lg:pl-10">
      ...
      <p className={`${styles.paragraph}`}>
        ...
        kami berkomitmen untuk memastikan tanaman Anda tumbuh dengan optimal dan
        bebas dari penyakit. Kami hadir untuk membantu petani mencapai hasil
        yang maksimal dan menjaga kelestarian lingkungan.
      </p>
      <ul className="space-y-3">
        <li>
          ...
          <p className={`${styles.paragraph} ml-5`}>
            ...
            berkelanjutan untuk memastikan kelangsungan pertanian di masa depan.
          </p>
        </li>
        <li>
          <h3 className={`${styles.list}`}>Edukasi dan Pelatihan Petani</h3>
          <p className={`${styles.paragraph} ml-5`}>
