  ...
  return (
    <div className="absolute top-16 space-y-4 px-4 md:px-14 lg:right-20">
      ...
      <p className="max-w-[400px] text-white lg:hidden">
        Meningkatkan produktivitas dan kesehatan tanaman Anda melalui solusi
        pertanian yang berkelanjutan dan inovatif bersama Dokter Tani, mitra
        terpercaya Anda.
      </p>
    </div>
  );
...
// Component for the paragraph shown in larger screens
const LayananParagraph = () => {
  return (
...
// Main component for the Layanan section
const Layanan = () => {
  return (
